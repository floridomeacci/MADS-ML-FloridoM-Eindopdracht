"""
Dutch Embeddings Loader
-----------------------
Loads and prepares Legal-Dutch-Roberta embeddings (768-dim).
Model: joelniklaus/legal-dutch-roberta-base
"""
...
from vectorizers import load_cached_embeddings, prepare_datasets, filter_to_rare_classes, balance_classes, balance_classes
...
def get_loaders(batch_size=32, max_chunks=30, num_classes=32):
    """
    Get train and validation loaders for Dutch embeddings.
